...
<div class="modal fade" id="passwdUpdateModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    ...
    <div class="container">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="#">所有员工资产情况</a></li>
                        <!--新增根据类型查看资产-->
        ...
        <div class="row">
            <div class="col-md-2 col-md-offset-10">
                <button class="btn btn-primary" id="dev_export_modal_btn">导出订单</button>
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        function to_page(status,pn) {
            $.ajax({
                url:"/device/getDevsByStatus",
        ...
        function build_devs_table(result) {
            ...
            $.each(devs,function (index,item) {
                ...
                $("<tr></tr>").append(IdTd).append(devNameTd).append(devTypeTd)
                        ...
                        .append(empNameTd).append(deptNameTd).appendTo("#device_table tbody");
        ...
        function build_page_nav(result){
            ...
            var options=$("#dev_status_select option:selected");
            if (result.extend.pageInfo.hasPreviousPage==false){
                ...
                firstPageLi.click(function () {
                    to_page(options.val(),1);
                });
                prePageLi.click(function () {
                    to_page(options.val(),result.extend.pageInfo.pageNum-1);
                });
            }
            ...
            if (result.extend.pageInfo.hasNextPage==false){
                ...
                lastPageLi.click(function(){
                    to_page(options.val(),result.extend.pageInfo.pages);
                });
            }
        ...
        $("#btn_submit").click(function () {
            $.ajax({
                url:"/device/getDevsByStatus",
                type:"GET",
                data:$("#form_submit").serialize()+"&pn="+1,
                success:function (result) {
                    var options=$("#dev_status_select option:selected");
                    to_page(options.val(),1);
                }
